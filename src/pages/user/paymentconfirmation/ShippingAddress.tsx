...
type ShippingAddressType = { id: number; address: string; phone: string; isDefault: boolean };
...
export default function ShippingAddress() {
  ...
  const setDefaultAddress = (id: number) => {
    setShippingAddresses(shippingAddresses.map(addr => ({ ...addr, isDefault: addr.id === id })));
