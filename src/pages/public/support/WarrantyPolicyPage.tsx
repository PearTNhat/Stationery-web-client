    ...
    <div className="max-w-7xl mx-auto px-4 py-16 bg-gray-100">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-extrabold text-blue-600 mb-4">
          Warranty Policy - Stationery's P
        </h1>
      ...
      <section className="space-y-12">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-3xl font-semibold text-gray-800 mb-3">
            1. Where Can I Claim a Warranty for My Product?
          </h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-3xl font-semibold text-gray-800 mb-3">
            2. Can I Get a Free Warranty for My Product?
          </h2>
          <p className="text-gray-600">Your product qualifies for a free manufacturer warranty under the following conditions:</p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-gray-600">
            Processing time is typically <strong>21–45 days</strong> if submitted through Stationery's P, excluding shipping time. Directly contacting the manufacturer may expedite the process.
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li><strong>Invoice:</strong> Present your purchase invoice.</li>
            <li><strong>Warranty Certificate:</strong> Use the certificate provided with your product.</li>
            <li><strong>Warranty Sticker:</strong> Ensure the sticker remains intact.</li>
            <li><strong>Electronic Warranty:</strong> Activate your warranty online.</li>
          </ul>
        </div>
