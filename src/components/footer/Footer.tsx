    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 px-4 mb-5">
      ...
      <div>
        ...
        <div>
            ...
            <ul>
                <li><a href="#" className="hover:text-blue-400">Product 1</a></li>
                <li><a href="#" className="hover:text-blue-400">Product 2</a></li>
                <li><a href="#" className="hover:text-blue-400">Product 3</a></li>
            </ul>
        </div>
        <div>
            <h3 className="font-bold text-lg mb-2">Subscribe for Updates</h3>
            <div className="mt-4 flex space-x-4 mb-4">
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="bg-blue-600 p-3 rounded-full hover:bg-blue-700 transition-colors">
                <FaFacebookF className="text-white text-xl" />
                </a>
                <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" className="bg-black p-3 rounded-full hover:bg-gray-800 transition-colors">
                <FaTiktok className="text-white text-xl" />
                </a>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-3 rounded-full hover:opacity-80 transition-opacity">
